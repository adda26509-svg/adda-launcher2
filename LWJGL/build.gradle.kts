...
tasks.jar {
    ...
    destinationDirectory.set(file("../AddaLauncher/src/main/assets/components/lwjgl3/"))
    // Auto update the version with a timestamp so the project jar gets updated by Pojav
    doLast {
        val versionFile = file("../AddaLauncher/src/main/assets/components/lwjgl3/version")
