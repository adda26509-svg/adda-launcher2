...
package com.adda.launcher.path
...
// TODO(Adda): point these at your own repo/org before shipping. Left as
// placeholders rather than guessed values — URL_PROJECT_INFO in particular
// drives the in-app update checker, so it must point at your own release feed.
const val URL_PROJECT: String = "https://github.com/YOUR_USERNAME/AddaLauncher"
const val URL_PROJECT_INFO: String = "https://api.github.com/repos/YOUR_USERNAME/AddaLauncher/contents/v2"
const val URL_COMMUNITY: String = "https://github.com/YOUR_USERNAME/AddaLauncher/graphs/contributors"
const val URL_WEBLATE: String = ""
