...
import com.adda.launcher.context.refreshContext
...
import com.adda.launcher.setting.loadAllSettings
import com.adda.launcher.ui.activities.showFatalError
import com.adda.launcher.ui.activities.showLauncherCrash
import com.adda.launcher.utils.device.Architecture
import com.adda.launcher.utils.logging.Logger
import com.adda.launcher.utils.writeCrashFile
...
@HiltAndroidApp
class AddaApplication : Application(), SingletonImageLoader.Factory {
    companion object {
        @JvmStatic
    ...
    override fun onCreate() {
        ...
        Thread.setDefaultUncaughtExceptionHandler { _, th ->
            ...
            showLauncherCrash(this@AddaApplication, throwable, th !is SplashException)
        ...
        runCatching {
            ...
            writeCrashFile(
                ...
                Log.w("AddaApplication", "An exception occurred while saving the crash report", it)
            }
