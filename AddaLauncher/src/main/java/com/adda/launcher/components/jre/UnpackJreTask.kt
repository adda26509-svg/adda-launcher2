...
package com.adda.launcher.components.jre

import android.content.Context
import android.content.res.AssetManager
import com.adda.launcher.AddaApplication
import com.adda.launcher.components.AbstractUnpackTask
...
class UnpackJreTask(
    ...
    private fun getRuntimeByArch() = "bin-" + Architecture.archAsString(AddaApplication.DEVICE_ARCHITECTURE) + ".tar.xz"
