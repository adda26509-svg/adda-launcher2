...
package com.adda.launcher.game.download.game

import android.content.Context
import android.content.Intent
import com.adda.launcher.R
import com.adda.launcher.context.GlobalContext
import com.adda.launcher.coroutine.Task
import com.adda.launcher.coroutine.TaskFlowExecutor
import com.adda.launcher.coroutine.TitledTask
import com.adda.launcher.coroutine.addTask
import com.adda.launcher.coroutine.buildPhase
import com.adda.launcher.game.addons.mirror.mapBMCLMirrorUrls
import com.adda.launcher.game.addons.modloader.ModLoader
import com.adda.launcher.game.addons.modloader.cleanroom.CleanroomVersion
import com.adda.launcher.game.addons.modloader.fabriclike.FabricLikeVersion
import com.adda.launcher.game.addons.modloader.forgelike.ForgeLikeVersion
import com.adda.launcher.game.addons.modloader.forgelike.neoforge.NeoForgeVersion
import com.adda.launcher.game.addons.modloader.modlike.ModVersion
import com.adda.launcher.game.download.assets.platform.mcim.mapMCIMMirrorUrls
import com.adda.launcher.game.download.game.cleanroom.getCleanroomDownloadTask
import com.adda.launcher.game.download.game.cleanroom.targetTempCleanroomInstaller
import com.adda.launcher.game.download.game.fabric.getFabricLikeCompleterTask
import com.adda.launcher.game.download.game.fabric.getFabricLikeDownloadTask
import com.adda.launcher.game.download.game.forge.getForgeLikeAnalyseTask
import com.adda.launcher.game.download.game.forge.getForgeLikeDownloadTask
import com.adda.launcher.game.download.game.forge.getForgeLikeInstallTask
import com.adda.launcher.game.download.game.forge.isNeoForge
import com.adda.launcher.game.download.game.forge.targetTempForgeLikeInstaller
import com.adda.launcher.game.download.game.optifine.getOptiFineDownloadTask
import com.adda.launcher.game.download.game.optifine.getOptiFineInstallTask
import com.adda.launcher.game.download.game.optifine.getOptiFineModsDownloadTask
import com.adda.launcher.game.download.game.optifine.targetTempOptiFineInstaller
import com.adda.launcher.game.download.jvm_server.JVMSocketServer
import com.adda.launcher.game.download.jvm_server.JvmService
import com.adda.launcher.game.path.getGameHome
import com.adda.launcher.game.version.download.BaseMinecraftDownloader
import com.adda.launcher.game.version.download.MinecraftDownloader
import com.adda.launcher.game.version.installed.VersionConfig
...
import com.adda.launcher.utils.file.copyDirectoryContents
import com.adda.launcher.utils.logging.Logger
import com.adda.launcher.utils.network.downloadFromMirrorListSuspend
import com.adda.launcher.utils.network.withSpeedReport
