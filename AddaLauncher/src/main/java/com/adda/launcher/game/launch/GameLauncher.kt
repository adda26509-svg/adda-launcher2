...
package com.adda.launcher.game.launch
...
import com.adda.launcher.AddaApplication
import com.adda.launcher.bridge.LoggerBridge.append
import com.adda.launcher.bridge.LoggerBridge.appendTitle
import com.adda.launcher.bridge.ZLBridge
import com.adda.launcher.context.readAssetFile
import com.adda.launcher.game.account.Account
import com.adda.launcher.game.account.AccountType
import com.adda.launcher.game.account.offline.OfflineYggdrasilServer
import com.adda.launcher.game.addons.modloader.ModLoader
import com.adda.launcher.game.download.game.parseLibraryComponents
import com.adda.launcher.game.multirt.Runtime
import com.adda.launcher.game.multirt.RuntimesManager
import com.adda.launcher.game.path.GamePathManager
import com.adda.launcher.game.plugin.driver.DriverPluginManager
import com.adda.launcher.game.plugin.renderer.RendererPluginManager
import com.adda.launcher.game.renderer.Renderers
import com.adda.launcher.game.support.touch_controller.ControllerProxy
import com.adda.launcher.game.version.installed.Version
import com.adda.launcher.game.version.installed.VersionInfoParser
import com.adda.launcher.game.version.installed.VersionsManager
import com.adda.launcher.game.versioninfo.models.GameManifest
import com.adda.launcher.path.LibPath
import com.adda.launcher.path.PathManager
import com.adda.launcher.setting.AllSettings
import com.adda.launcher.utils.GSON
import com.adda.launcher.utils.device.Architecture
import com.adda.launcher.utils.file.child
import com.adda.launcher.utils.file.ensureDirectorySilently
import com.adda.launcher.utils.logging.Logger
import com.adda.launcher.utils.string.isBiggerTo
import com.adda.launcher.utils.string.isEqualTo
...
class GameLauncher(
    ...
    private fun printLauncherInfo(
        ...
        append("▷ Architecture: ${Architecture.archAsString(AddaApplication.DEVICE_ARCHITECTURE)}")
