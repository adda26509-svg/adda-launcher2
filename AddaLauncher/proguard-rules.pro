...
-keep class com.adda.launcher.bridge.** { *; }
-keep class com.adda.launcher.utils.device.VulkanChecker {
    *;
}
-keep class com.adda.launcher.utils.device.VulkanCapabilities {
    *;
}
-keep interface com.adda.launcher.utils.device.VulkanLogCallback {
    *;
}
-keep class com.adda.launcher.game.input.CriticalNativeTest {
    *;
}
